...
template_file = "C://Resumer//App//resume_template.docx"  # Update with your actual path
...
def resume_generator():
    ...
    if submitted:
        ...
        st.write("Made by Khadija Ijaz and Ayesha Barlas", unsafe_allow_html=True)
...
def run():
    ...
    activities = ["Resume Generator","User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
